...
use Aldaflux\AldafluxStandardUserCommandBundle\Service\Validator;
...
#[AsCommand('suc:user:add', 'Creates users and stores them in the database')]
class AddUserCommand extends UserCommand
{
    ...
    {
        $this->setDescription('Creates users and stores them in the database')
